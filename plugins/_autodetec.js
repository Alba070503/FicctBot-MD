...
await this.sendMessage(m.chat, { text: `${usuario} Se Cambio la foto del grupo ⚡`, mentions: [m.sender] }, { quoted: fkontak }) 
} else if (m.messageStubType == 24) {
await this.sendMessage(m.chat, { text: `${usuario} Se cambio la descripción del grupo:\n\n${m.messageStubParameters[0]}`, mentions: [m.sender] }, { quoted: fkontak })
...
txt1 += `Le otorgó admin: @${m.sender.split`@`[0]}`/*, mentions: (await conn.groupMetadata(m.chat)).participants.map(v => v.id)*/ }, { quoted: fkontak })
